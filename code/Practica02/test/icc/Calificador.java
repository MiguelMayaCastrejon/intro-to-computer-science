/**
 * Código utilizado para el curso de ICC.
 *
 ...
 * pruebas unitarias.
 *
 * Las pruebas se definen en clases hijas de esta clase, y deben sobrescribir
 * el método init. Para empezar cada prueba se debe utilizar los métodos
 * startTest y deben finalizar con el método passed, mientras que el aumento de
 * aciertos por prueba unitaria se hace con el método addUp.
 *
 * @author mindahrelfen
 */
public abstract class Calificador {
     ...
     * clases que definen a las pruebas unitarias.
     *
     ...
     *
     * Por defecto solo se tiene una categoría a calificar sin nombre y con
     * 1.0 de 1.0 aciertos.
     */
     ...
     * aleatorios enteros en forma de String va a trabajar.
     *
    ...
    /**
     * Define las categorías a calificar, recibe dos arreglos de misma
     * longitud, uno con los nombres de cada categoría y el otro con los
     * porcentajes. La suma de dichos porcentajes debe ser iguala uno.
     *
    ...
    /**
     * Imprime el resumen de la prueba si no se ha impreso ya, además imprime
